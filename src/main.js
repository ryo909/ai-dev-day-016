import './style.css';
const PROFILE = {"day":"Day016","title":"Budget Tradeoff Calculator","one_sentence":"予算配分の妥協点を重み付きで可視化する計算ダッシュボード。（話題:HN Frontpage）","core_action":"optimize","family":"budget_optimization","mechanic":"constrained_weighted_formula","input_style":"slider_weights_and_rows","output_style":"ranked_scores","audience_promise":"faster_budget_alignment","publish_hook":"予算制約下の最適配分を即比較","engine":"weighted_calc","interaction_archetype":"weighted_calculator","page_archetype":"calculator_dashboard","output_shape":"ranked_table","state_model":"weights_plus_option_rows","core_loop":"set budget -> tune weights -> rebalance","component_pack":"slider_panel+constraint_banner","scaffold_id":"weighted_calculator","single_shot_text_generator":false};
